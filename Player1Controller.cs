...
public class Player1Controller : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Player 2 is blue");
    }

    void getBallColour()
    {
        if (isChanged()) // it goes to the method ifChanged and if it is returned true it runs, if it returns false it doesn't run
        {
            Debug.Log("Player 2 is " + ballColour);
            // tells you which player has which colour in the console in unity, this is the script for player 2
